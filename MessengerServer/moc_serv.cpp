...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_serv_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_serv_t qt_meta_stringdata_serv = {
    {
QT_MOC_LITERAL(0, 0, 4), // "serv"
QT_MOC_LITERAL(1, 5, 17), // "slotNewConnection"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 14) // "slotReadClient"

    },
    "serv\0slotNewConnection\0\0slotReadClient"
};
...
QT_INIT_METAOBJECT const QMetaObject serv::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_serv.data,
    qt_meta_data_serv,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *serv::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_serv.stringdata0))
